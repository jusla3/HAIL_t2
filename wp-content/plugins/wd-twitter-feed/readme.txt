...
Since version 1.4.3, Twitter Feed comes with a PHP based API that allows you to fetch tweets anywhere without having to use shortcodes. For more information, visit the [API documentation](http://products.askupasoftware.com/twitter-feed/api/) page.
...
8. Visual editor shortcode placeholders

== Changelog ==

= 3.0.8 = 
* (FIX) Fixed an issue that was causing the customizer to break
...
= 3.0.1 =
* Installing this version will autimatically migrate your old (pre v3.0.0) settings. We're sorry for the inconvenience this might have caused you.
