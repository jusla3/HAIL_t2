...
createCanvas.setAttribute("id", "slider_hero_circle_canvas");
	
var canvas = document.getElementById("slider_hero_circle_canvas");
var ctx = canvas.getContext("2d");
var cw = canvas.width = $('#'+mainId).width(),
  cx = cw / 2;
var ch = canvas.height = $('#'+mainId).height(),
  cy = ch / 2;

ctx.fillStyle = "#000";
var circlesRy = [];
var circlesNum = total_circle;
var requestId = null;
...
function Init() {
  ...
  cw = canvas.width = $('#'+mainId).width(),
    cx = cw / 2;
  ch = canvas.height = $('#'+mainId).height(),
    cy = ch / 2;
